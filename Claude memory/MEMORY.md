# Index mémoire — Fraiseuse Semi-CNC

| Fichier | Type | Description |
|---------|------|-------------|
| [user_profile.md](user_profile.md) | user | Profil Steph — stack, domaines, préférences techniques |
| [feedback_preferences.md](feedback_preferences.md) | feedback | Backups avant modifs, scripts à lancer soi-même, français |
